...
# 2045 "/usr/include/curses.h" 3 4
extern void trace (const unsigned int);
# 2076 "/usr/include/curses.h" 3 4
...
# 2077 "/usr/include/curses.h" 2 3 4
# 11 "common.h" 2
...
void accept_client(int server_listen) {
    int client_fd = -1;
    client_fd = accept(server_listen, 
# 26 "server7.c" 3 4
                                     ((void *)0)
# 26 "server7.c"
                                         , 
...
# 51 "server7.c"
            ...
            num = recv(client_fd, buff, 1024, 0);
            if (num <= 0) {
...
# 87 "server7.c"
        ...
        ret = select(s_d->maxfd + 1, readfds, 
# 91 "server7.c" 3 4
                                             ((void *)0)
# 91 "server7.c"
                                                 , 
...
int main() {
    ...
    s_d->client_cnt = 0;
    s_d->maxfd = 0;
    server_listen = socket_create(7777);
