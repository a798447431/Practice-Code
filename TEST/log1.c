...
void init_testinfo(test, FuncName;
__attribute__((constructor)) 
void add_Test0() { 
    pFuncData p = (pFuncData)malloc(sizeof(FuncData)); 
    ptest_info ti = init_test_info(ti); 
    p->func = test_is_prime_func_Test; 
    p->name_part1 = "test"; 
    p->name_part2 = "is_prime_func"; 
    p->next = head; head = p;
}
void test_is_prime_func_Test() {
...
void test_add_func_Test();
void init_testinfo(test, FuncName;__
attribute__((constructor)) 
void add_Test1() {
    pFuncData p = (pFuncData)malloc(sizeof(FuncData)); 
    ptest_info ti = init_test_info(ti); 
    p->func = test_add_func_Test; 
    p->name_part1 = "test"; 
    p->name_part2 = "add_func"; 
    p->next = head; head = p;
}
void test_add_func_Test() {
